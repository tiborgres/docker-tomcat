...
# copy sample.war as example.war to /usr/local/tomcat/webapps
ADD https://tomcat.apache.org/tomcat-9.0-doc/appdev/sample/sample.war /usr/local/tomcat/webapps/example.war
